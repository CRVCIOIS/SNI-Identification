...
The smaller dataset will contain a maximum of `nr_of_each_SNI` companies with the same SNI code.
The input data file should be in JSON format.
"""
import json
import logging
import subprocess
...
def main(
    ...
    :param: output_path_dev_set (Path): The path to the output data file.
    :param: nr_of_each_SNI (int, optional): The maximum number of companies with the same SNI code in the smaller dataset. Defaults to 10.
    """
