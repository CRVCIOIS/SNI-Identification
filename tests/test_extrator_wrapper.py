...
> pytest tests/test_extractor_wrapper.py
"""
import requests
from pathlib import Path
from scripts.postprocess import extractor_wrapper
import pytest
import tldextract
import json
...
def test_structure(tmp_path, temp_scraped_data, temp_dataset):
    ...
    extractor_wrapper(temp_scraped_data, temp_dataset, temp_output_file, extract_meta=True, extract_body=False, p_only=False)
